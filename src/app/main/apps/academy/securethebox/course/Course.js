                                            ...
                                            <div className="flex justify-center p-16 pb-64 sm:p-24 sm:pb-64 md:p-48 md:pb-64" key={step.id + index}>
                                                <Paper className="w-full max-w-lg rounded-8 p-16 md:p-24" elevation={1}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <br/>
                                                        <Button onClick={() => testGithub('us-west1-a', 'charles', 'apply', 'jidokaus@gmail.com')}>Test Github</Button>
                                                        <Button onClick={() => testJuiceshop('us-west1-a', 'charles', 'delete', 'jidokaus@gmail.com')}>Test Juice-Shop</Button>
                                                    </div>
                                                </Paper>
                                            </div>
                                        )
